...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        // Pie Chart
        // country is changed to state for ADIB's convenience!
        ...
        $countryLabels = ArrayHelper::getColumn($countriesData, 'state');

        $colorOptions = ['#4e73df', '#1cc88a', '#36b9cc','#c82347']; // only 4 colors
        $bgColors = [];
