        ...
        var myLineChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              ...
              borderColor: "#00affe",
              pointRadius: 3,
              pointBackgroundColor: "#00affe",
              pointBorderColor: "#00affe",
              pointHoverRadius: 3,
              pointHoverBackgroundColor: "#00affe",
              pointHoverBorderColor: "#00affe",
              pointHitRadius: 10,
              pointBorderWidth: 2,
              ...
              yAxes: [{
                ticks: {
                  ...
                  callback: function (value, index, values) {
                    return 'ETB ' + number_format(value);
                  }
                },
                gridLines: {
            ...
            tooltips: {
              ...
              callbacks: {
                label: function (tooltipItem, chart) {
                  ...
                  return datasetLabel + ': ETB ' + number_format(tooltipItem.yLabel);
                }
              }
            }
          }
