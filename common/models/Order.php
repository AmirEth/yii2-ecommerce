 ...
 * @property string|null  $paid_account
 * @property int|null     $created_at
 * @property int|null     $created_by
 * @property string|null  $otp
 * @property int|null     $otp_generated_at
 * @property int|null     $otp_expiry
 *
...
class Order extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['total_price', 'status', 'firstname', 'lastname', 'email', 'phone_number'], 'required'],
            [['total_price'], 'number'],
            [['email'], 'email'],
            [['phone_number'], 'string', 'max' => 20],
            [['status', 'created_at', 'created_by'], 'integer'],
            [['firstname', 'lastname'], 'string', 'max' => 45],
            [['email', 'transaction_id', 'paid_account'], 'string', 'max' => 255],
            [['created_by'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['created_by' => 'id']],
            [['otp', 'otp_generated_at', 'otp_expiry'], 'safe'],
            [['otp'], 'string', 'length' => 6],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'paid_account' => 'Paypal Order ID',
            'created_at' => 'Created At',
            'created_by' => 'Created By',
            'otp' => 'OTP',
            'otp_generated_at' => 'OTP Generated At',
