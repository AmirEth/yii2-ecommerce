    ...
    <div class="card-body">
        <div class="container mb-5 mt-3">
            <div class="row d-flex align-items-baseline">
                <div class="col-xl-9">
                    <p style="color: #7e8d9f; font-size: 20px;">RefNo >> <strong><?= Html::encode($order->transaction_id) ?></strong></p>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <ul class="list-unstyled">
                            ...
                            <li class="text-muted"><i class="fas fa-phone"></i>0972795880</li>
                        </ul>
                    </div>
                    <div class="col-xl-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="text-muted"><i class="fas fa-circle" style="color: #84B0CA;"></i> <span class="me-1 fw-bold">Status: </span><span class="badge bg-warning text-danger fw-bold"> Not Paid</span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-10">
                        <p>Please Complete The payment using ADIB E-Banking or at ADIB branch with the referance number</p>
                    </div>
                    <div class="col-xl-2">
